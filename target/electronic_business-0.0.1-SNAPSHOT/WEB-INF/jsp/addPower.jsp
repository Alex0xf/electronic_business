                            ...
                            <div class="row">
                                <div class="col-md-5 col-md-offset-2">
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group " id="powerNameDiv">
                                            <label class="control-label userNameLable" for="inputSuccess2">权限名称</label>
                                            <input type="text" class="form-control userName" id="inputSuccess2"
                                                   placeholder="权限名称"  name="name">

                                        </div>
                                        <div class="form-group " id="powerDescriptionDiv">
                                            <label class="control-label userNameLable" for="inputSuccess2">权限描述</label>
                                            <input type="text" class="form-control userName" id="inputSuccess3"
                                                   placeholder="权限描述"  name="name">
